...
<head>
  ...
  <title>Laporan - Inventory Product</title>
...
<ul class="sidebar-nav" id="sidebar-nav">
        ...
        <div class="col-lg-6">
          <div class="card shadow-sm">
            <div class="card-body">
              ...
              <div class="d-flex justify-content-between align-items-center">
                <span class="fw-bold text-success">Total Transasksi: <?=  $total_barang_masuk;  ?></span>
        ...
        <div class="col-lg-6">
          <div class="card shadow-sm">
            <div class="card-body">
              ...
              <div class="d-flex justify-content-between align-items-center">
                <span class="fw-bold text-danger">Total Transasksi: <?=  $total_barang_keluar;  ?></span>
  ...
  <footer id="footer" class="footer">
    ...
    <div class="credits">
     Designed by <a href="https://bootstrapmade.com/">Kirani Cinta Mentari</a>
    </div>
  </footer><!-- End Footer -->
