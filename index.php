...
$q_keluar = mysqli_query($conn, "SELECT DAY(created_at) as hari, SUM(qty) as total FROM stock_logs
...
<head>
  ...
  <title>Dashboard - Inventory Product </title>
...
<body>
  ...
  <footer id="footer" class="footer">
    ...
    <div class="credits">
      Designed by <a href="https://www.instagram.com/_kiranicintaa">Kirani Cinta Mentari</a>
    </div>
  </footer><!-- End Footer -->
